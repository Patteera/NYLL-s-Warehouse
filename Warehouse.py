        ...
        for i in range(25):
            if i < 20:
                ...
                if self.pdid[0][1] in string.ascii_uppercase[i]:
                    if int(self.pdid[0][2:5]) < 360:
                        for n in range(20):
                            if int(self.pdid[0][2:5]) >= 100 + (12 * (n)) + n and int(self.pdid[0][2:5]) < 100 + (
                                    12 * (n + 1)) + n + 1:
                                self.RW.append(n + 1)
                    if int(self.pdid[0][2:5]) >= 360 and int(self.pdid[0][2:5]) < 487:
                        for n in range(2):
                            if int(self.pdid[0][2:5]) >= 360 + (100 * n) + n and int(self.pdid[0][2:5]) < 360 + (
                                    100 * (n + 1)) + n + 1:
                                self.RW.append(n + 1)
                    if int(self.pdid[0][2:5]) > 486 and int(self.pdid[0][2:5]) < 600:
                        for n in range(2):
                            if int(self.pdid[0][2:5]) >= 487 + (100 * n) and int(self.pdid[0][2:5]) < 487 + (
                                    100 * (n + 1)) + n:
                                self.RW.append(n + 1)
            elif i == 21:
                if self.pdid[0][1] in string.ascii_uppercase[i]:
                    if int(self.pdid[0][2:5]) >= 100 and int(self.pdid[0][2:5]) < 173:
                        for n in range(3):
                            if int(self.pdid[0][2:5]) >= 100 + (73 * n) + n and int(self.pdid[0][2:5]) < 100 + (
                                    72 * (n + 1)) + n + 1:
                                self.RW.append(n + 2)
                    if int(self.pdid[0][2:5]) >= 173 and int(self.pdid[0][2:5]) < 473:
                        for n in range(3):
                            if int(self.pdid[0][2:5]) >= 173 + (100 * n) + n and int(self.pdid[0][2:5]) < 173 + (
                                    100 * (n + 1)) + n + 1:
                                self.RW.append(n + 3)
                    ...
                    if int(self.pdid[0][2:5]) >= 487 and int(self.pdid[0][2:5]) < 600:
                        for n in range(2):
                            if int(self.pdid[0][2:5]) >= 487 + (72 * n) + n and int(self.pdid[0][2:5]) < 487 + (
                                    72 * (n + 1)) + n + 1:
                                self.RW.append(n + 2)
            elif i == 22:
                if self.pdid[0][1] in string.ascii_uppercase[i]:
                    ...
                    if int(self.pdid[0][2:5]) >= 186 and int(self.pdid[0][2:5]) < 487:
                        for n in range(4):
                            if int(self.pdid[0][2:5]) >= 186 + (99 * n) + n and int(self.pdid[0][2:5]) < 186 + (
                                    99 * (n + 1)) + n + 1:
                                self.RW.append(n + 2)
                    if int(self.pdid[0][2:5]) >= 487 and int(self.pdid[0][2:5]) < 600:
                        for n in range(2):
                            if int(self.pdid[0][2:5]) >= 487 + (85 * n) + n and int(self.pdid[0][2:5]) < 487 + (
                                    85 * (n + 1)) + n + 1:
                                self.RW.append(n + 1)
            elif i == 23:
                if self.pdid[0][1] in string.ascii_uppercase[i]:
                    ...
                    if int(self.pdid[0][2:5]) >= 199 and int(self.pdid[0][2:5]) < 487:
                        for n in range(3):
                            if int(self.pdid[0][2:5]) >= 199 + (100 * n) + n and int(self.pdid[0][2:5]) < 199 + (
                                    100 * (n + 1)) + n + 1:
                                self.RW.append(n + 1)
                    if int(self.pdid[0][2:5]) >= 487 and int(self.pdid[0][2:5]) < 600:
                        for n in range(2):
                            if int(self.pdid[0][2:5]) >= 487 + (99 * n) + n and int(self.pdid[0][2:5]) < 487 + (
                                    99 * (n + 1)) + n + 1:
                                self.RW.append(n + 1)
            elif i == 24:
                if self.pdid[0][1] in string.ascii_uppercase[i]:
                    ...
                    if int(self.pdid[0][2:5]) >= 112 and int(self.pdid[0][2:5]) < 312:
                        for n in range(3):
                            if int(self.pdid[0][2:5]) >= 112 + (99 * n) + n and int(self.pdid[0][2:5]) < 112 + (
                                    99 * (n + 1)) + n + 1:
                                self.RW.append(n + 4)
                    if int(self.pdid[0][2:5]) >= 312 and int(self.pdid[0][2:5]) < 487:
                        for n in range(7):
                            if int(self.pdid[0][2:5]) >= 312 + (24 * n) + n and int(self.pdid[0][2:5]) < 312 + (
                                    24 * (n + 1)) + n + 1:
                                self.RW.append(n + 1)
                    if int(self.pdid[0][2:5]) >= 487 and int(self.pdid[0][2:5]) < 600:
                        for n in range(7):
                            if int(self.pdid[0][2:5]) >= 487 + (25 * n) + n and int(self.pdid[0][2:5]) < 487 + (
                                    25 * (n + 1)) + n + 1:
                                self.RW.append(n + 1)
